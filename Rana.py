...
\033[1;91m☞ Auther     : RANA PARACETAMOL
\033[1;92m☞ WhatsApp   : 03128186223
\033[1;95m☞ YouTube    : RANA OFFICIAL
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update RANA Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' RanaWhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $rana/Paracetamol')
	    os.system('cd rana&& git clone https://github.com/ranaparacetamol/mandokhail')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03128186223✓')
	    psb('WellCome To Rana Mandokhail')
	    psb('Congratulations Rana Mandokhail Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ mandokhail✓')
	    psb('🔓Password ☆ rana✓')
	    psb('Subscrib My Youtube Channel Rana Mandokhail✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/rana && python2 rana.py')
	elif bm =='3':
